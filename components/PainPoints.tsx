        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", borderTop: "1px solid var(--border)" }}
          ...
          {items.map(({ n, title, desc }) => (
            <div key={n} style={{
              ...
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 13, color: "var(--accent)", marginBottom: 24 }}>{n}</div>
              <h3 style={{
              ...
              <p style={{ fontFamily: "var(--font-sans)", fontSize: 14, lineHeight: 1.5, color: "var(--dim)", margin: 0 }}>{desc}</p>
            </div>
          ))}
        </div>

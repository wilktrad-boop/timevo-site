    ...
    <section style={{ padding: "96px 28px", borderTop: "1px solid var(--border)" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 24, padding: 48 }}>
          <div style={{ fontFamily: "var(--font-sans)", fontSize: 18, color: "var(--accent)", marginBottom: 18 }}>"</div>
          <p style={{
            fontFamily: "var(--font-sans)", fontSize: "clamp(18px, 2vw, 28px)", fontWeight: 500,
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 36 }}>
            <div style={{
              ...
              fontFamily: "var(--font-sans)", fontSize: 14, fontWeight: 600, flexShrink: 0,
            }}>{it.initials}</div>
            <div>
              <div style={{ fontFamily: "var(--font-sans)", fontSize: 14, fontWeight: 600, color: "var(--text)" }}>{it.name}</div>
              <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "var(--dim)" }}>{it.role}</div>
            </div>
